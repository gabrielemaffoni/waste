...
public class Item {
    ...
    public static final String QUANTITY_DB = "total_quantity";
    ...
    public Item(String item_key, String product_name, Double current_quantity, Double total_quantity, String measure, String product_type, String expiration_date, String brand, Double internal_temperature, Double external_temperature, Double optimal_temperature) {
    ...
    public String printItem() {
        ArrayMap<String, Object> all_data = new ArrayMap<>();
